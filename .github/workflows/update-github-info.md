...
Review the official GitHub Blog and GitHub Changelog content to understand recent product and platform updates. Summarize the most relevant updates in plain, concise language that fits the tone of the site and matches Mona's notes.

Update `site/content/github-info.md` with practical, useful changes for readers. Include source context when the content comes from the GitHub Blog or GitHub Changelog and keep the update accurate and concise.
